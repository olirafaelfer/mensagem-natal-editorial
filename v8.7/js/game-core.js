  ...
  function openSpecialMission(){
    openModal({
      ...
      bodyHTML: `
        <div class="special-wrap" style="text-align:center">
          ...
          <p style="margin:0 0 10px"><b>A missão especial de Natal é:</b> <span style="text-transform:uppercase">COMPARTILHAR ESTE DESAFIO COM SEUS AMIGOS E FAMILIARES!</span></p>
          <button class="btn" id="specialShareBtn" type="button" style="width:100%; justify-content:center">📤 Compartilhar</button>
          <p class="muted" style="margin:10px 0 0; font-size:12px">
            Link: <a href="https://olirafaelfer.github.io/mensagem-natal-editorial/" target="_blank" rel="noopener">https://olirafaelfer.github.io/mensagem-natal-editorial/</a>
          </p>
    ...
    setTimeout(() => {
      ...
      btn.addEventListener('click', async ()=>{
        ...
        const text = 'A missão especial de Natal é: COMPARTILHAR ESTE DESAFIO COM SEUS AMIGOS E FAMILIARES!';
        try{
