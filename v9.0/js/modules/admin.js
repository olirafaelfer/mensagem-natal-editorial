...
export function bootAdmin(app) {
  ...
  // V8: Removido "gate" por senha no client (inseguro). Admin real deve ser controlado por:
  // - Firebase Auth + Custom Claims (token.admin == true) OU
  // - Regras do Firestore/Functions
  ...
  // V8: removido "gate" por senha hardcoded no client (inseguro).
