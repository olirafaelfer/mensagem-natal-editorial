...
export default {
  ...
  raw: `Vêm em cada ano e virão para sempre. E com o Natal vem as recordações e os costumes. Essas recordação cotidianas humildes às que todas as mães nos agarramos. Como a Virgem Maria, nos rincões secreto de seus coração.
(Marjorie Holmes)`,
correctText: `Vem em cada ano e virá para sempre. E com o Natal vêm as recordações e os costumes. Essas recordações cotidianas humildes às que todas as mães se agarramos. Como a Virgem Maria, nos rincões secretos de seu coração.
(Marjorie Holmes)`,
  rules: RULES
};
